...
export class ProdutoServiceBase {
  ...
  async getCatalogo(parentId: string): Promise<PrismaCatalogo | null> {
  ...
  async getCategoria(parentId: string): Promise<PrismaCategoria | null> {
    return this.prisma.produto
      .findUnique({
        where: { id: parentId },
      })
  ...
  async getMarca(parentId: string): Promise<PrismaMarca | null> {
    return this.prisma.produto
      .findUnique({
        where: { id: parentId },
      })
